...
class TourInclusionController extends Controller
{
    ...
    {
        $query =IncludedExcluded::with('tour');
    ...
    public function store(Request $request)
    {
        ...
        $inclusion = IncludedExcluded::create($validated);
        $inclusion->load('tour');
    ...
    {
        $inclusion = IncludedExcluded::with('tour')->find($id);
    ...
    {
        $inclusion = IncludedExcluded::find($id);
